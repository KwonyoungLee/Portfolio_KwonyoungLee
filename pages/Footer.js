        ...
        <Fade bottom>
            <div className="relative bg-neutral-900 py-18 sm:px-8 sm:pt-14 sm:pb-8">
                <div className="absolute inset-x-0 -top-4 flex justify-center sm:-top-6">
                    <div className="rounded-full bg-neutral-100 p-1 ring-white ring-offset-2 ring-offset-gray-700/80 focus:outline-none focus:ring-2 sm:p-2"
                    >
                    <a href="#home">
                ...
                <div className="flex gap-x-4 text-neutral-500 text-3xl">
                    ...
                    <a href='https://www.instagram.com/duckee_lee/'>
                        <BsInstagram />
                    </a>
                    <a href='https://github.com/KwonyoungLee'>
                        <BsGithub />
                    </a>
                </div>
